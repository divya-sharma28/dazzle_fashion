...
export const checkout = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    // console.log("heelo")
    const key = await userRequest.get(`/checkout/getkey`);
    // console.log(key.data.key,"key")
    // console.log("world")

    const response = await userRequest.post(`/checkout/payment`, payload);
    ...
    try {
      ...
      const options = {
        ...
        callback_url: `${import.meta.env.VITE_BASE_URL}/checkout/verify`,
        notes: {
